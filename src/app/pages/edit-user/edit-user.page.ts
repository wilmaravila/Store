...
export class EditUserPage implements OnInit {
 ...
 color: string = "";
  ...
  sendEditProfile(){
    ...
    console.log(this.name, this.email, this.phone, this.edad,this.fecha_nacimiento, this.genero, this.pais);
