...
export class ProductsPage implements OnInit {
  ...
  obtenerProducto(id:number): Product | undefined {
  ...
  ngOnInit() {
    this.numProducts=this.allProducts.length
  }
